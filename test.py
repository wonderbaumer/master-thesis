...
if __name__== "__main__":
    material = "silicate"
    par = dust_properties(material , "slow" , init_dist = 1.0 , size = "C")
    res = np.load("Files/rk45_t7_C_silicate_slowsw.npz")
    ...
    m_phys = mpert * par.m0
    print(beta0[-1] , b[-1] , len(beta0) , par.epsilon)
    # plt.plot(t , beta0 , label = "pert")
    # plt.plot(t , b , label = "num")
    # plt.legend()
    # plt.show()
