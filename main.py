...
def main(comp_type , time , solver = None , massloss = True , rk_file = None , lf_file = None 
    ...
    elif comp_type == "theta": #input rkfile and lffile, only one of the files or a specified solver
    ...
    elif comp_type == "r": #input rkfile and lffile, only one of the files or a specified solver
...
if __name__ == "__main__":
    ...
    comp_type = "energy"
    rk_file = "Files/RK45_masslossFalse_t6.npz"
    lf_file = "Files/LEAPFROG_masslossTrue_t6.npz"
    

    main(comp_type , t6 , solver = "RK45" , rk_file = rk_file , lf_file = None , massloss = False , fw_err = False)