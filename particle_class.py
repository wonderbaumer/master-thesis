...
if __name__ == "__main__":
    par = dust_properties("silicate" , "slow" , init_dist = 1 , size = "C")
    ...
    np.savez("Files/rk45_t6_C_silicate_slowsw.npz" , x = x[::10] , y = y[::10] , vx = vx[::10] , vy = vy[::10] , m = m[::10] , b = b[::10] , t = t[::10] , dmdt = dmdt[::10])
