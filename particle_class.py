...
from config import t5 , t6 , t7 , t8 , t9 , t10 , material_files , betahat0 , mhat0 , init_cart_scaled , yr
...
if __name__ == "__main__":
    par = dust_properties("carbon" , "slow" , "particle2")
    p = particle_solver(t8 , par , "RK45" , massloss = True)
    ...
    # np.savez("Files/rk45_t8_large_carbon_CMEsw_1AU_gradient.npz" , x = x[::10] , y = y[::10] , vx = vx[::10] , vy = vy[::10] , m = m[::10] , b = b[::10] , t = t[::10])
